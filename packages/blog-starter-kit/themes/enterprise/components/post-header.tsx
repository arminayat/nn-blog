...
export const PostHeader = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-row flex-wrap items-center justify-start w-full mx-auto gap-2 px-2 text-slate-700 max-w-screen-md dark:text-neutral-300 md:px-0">
        ...
        <div className="mb-5 flex w-full flex-row items-center justify-center md:mb-0 md:w-auto md:justify-start">
          ...
          {readTimeInMinutes && (
            <span className="mx-3 font-bold text-slate-500">&middot;</span>
          )}
