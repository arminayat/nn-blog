...
const fontRegular = fetch(
  new URL(
    "../../../assets/Roboto_Slab/static/RobotoSlab-Regular.ttf",
    import.meta.url,
  ),
...
const fontMedium = fetch(
  new URL(
    "../../../assets/Roboto_Slab/static/RobotoSlab-Medium.ttf",
    import.meta.url,
  ),
).then((res) => res.arrayBuffer());
...
const fontSemiBold = fetch(
  new URL(
    "../../../assets/Roboto_Slab/static/RobotoSlab-SemiBold.ttf",
    import.meta.url,
  ),
).then((res) => res.arrayBuffer());
...
const fontBold = fetch(
  new URL(
    "../../../assets/Roboto_Slab/static/RobotoSlab-Bold.ttf",
    import.meta.url,
  ),
).then((res) => res.arrayBuffer());
